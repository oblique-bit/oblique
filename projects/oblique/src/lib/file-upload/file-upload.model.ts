...
export enum ObEMimeTypes {
	...
	'application/msexcel' = 'xls|xla',
	'application/vnd.openxmlformats-officedocument.wordprocessingml.document' = 'docx|dotm',
	'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' = 'xlsx|xlsxm',
