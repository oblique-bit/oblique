...
@NgModule({
	declarations: [ObMockErrorMessagesComponent, ObMockMatErrorDirective, ObMockErrorMessagesDirective],
	exports: [ObMockErrorMessagesComponent, ObMockMatErrorDirective, ObMockErrorMessagesDirective],
