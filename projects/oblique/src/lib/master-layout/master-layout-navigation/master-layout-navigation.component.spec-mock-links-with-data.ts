		...
		children: [
			{
				...
				children: [
					{
						url: 'item-prefix-2-child-1-grandchild-1',
						label: 'ItemPrefix2Child1Grandchild1',
						id: 'prefix-child-1-grandchild-1',
					},
					{
						url: 'item-prefix-2-child-1-grandchild-2',
						label: 'ItemPrefix2Child1Grandchild2',
						id: 'prefix-child-1-grandchild-2',
					},
				],
			},
			{
				...
				children: [
					{
						url: 'item-prefix-2-child-2-grandchild-1',
						label: 'ItemPrefix2Child2Grandchild1',
						id: 'prefix-child-2-grandchild-1',
					},
					{
						url: 'item-prefix-2-child-2-grandchild-2',
						label: 'ItemPrefix2Child2Grandchild2',
						id: 'prefix-child-2-grandchild-2',
					},
				],
			},
		],
