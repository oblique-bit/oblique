...
const appRoutes: Routes = [
	...
	{path: 'material', loadChildren: async () => import('./material/material.module').then(module => module.MaterialModule)},
	{path: 'styles', loadChildren: async () => import('./styles/styles.module').then(module => module.StylesModule)},
	{path: 'starterkit', loadChildren: async () => import('./starterkit/starterkit.module').then(module => module.StarterkitModule)},
	{
		path: 'design-system',
