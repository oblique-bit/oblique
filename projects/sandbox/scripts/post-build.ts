...
const pathToIndexFile = getAbsolutePath('dist/sandbox/index.html');
const pathToSecurityHeadersFile = getAbsolutePath('dist/sandbox/nginx/conf/includes/security_headers.conf');
