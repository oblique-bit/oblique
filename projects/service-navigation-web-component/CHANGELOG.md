...
- **sample:** add `accessibilityText` text ([dcdf4a03](https://github.com/oblique-bit/oblique/commit/dcdf4a039d639b86f29af9842c988c50cf45398a))
- **sample:** add `tooltip` text ([32c18961](https://github.com/oblique-bit/oblique/commit/32c18961ef1ce4cb0b4228f3f7bff1395fff4978))
