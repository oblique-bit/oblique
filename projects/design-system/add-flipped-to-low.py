#!/usr/bin/env python3
"""
Add .inversity-flipped counterparts to L3 emphasis low.json
These will reference {ob.s.color.l2.*.inversity-flipped} tokens
"""

import json

def add_inversity_flipped_to_low():
    ...
    print("✅ Successfully added .inversity-flipped counterparts to low.json")
    return True

if __name__ == "__main__":
    success = add_inversity_flipped_to_low()
    if success:
        print("\n🔄 Addition complete!")
        print("📁 low.json now has both .inversity-normal and .inversity-flipped variants")
