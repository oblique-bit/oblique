...
Lint.initialize(hasFlag('fix'))
	.esLint(Files.buildOSSafePath(`${rootPath}/projects/design-system/**/*.{ts,js,mjs,html}`), rootPath)
	.styleLint(Files.buildOSSafePath(`${rootPath}/projects/design-system/**/*.{css,scss}`))
	.prettier(Files.buildOSSafePath(`${rootPath}/projects/design-system/**/*.{ts,js,mjs,html,json,yml,md,css,scss}`))
	.finalize();
Log.success();
