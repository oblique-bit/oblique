# Figma MCP Prompt Validation Report: 03-analyze-semantic-tokens
...
This report analyzes the effectiveness, usability, and current relevance of the `03-analyze-semantic-tokens` prompt for Figma MCP operations.
