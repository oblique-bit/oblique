...
**Scope:** Token fundamentals, [semantic layer architecture](03-semantic.md), and navigation to specialized color documentation.

**Technical Context:** This documentation reflects the current implementation state of the design token architecture. It serves as a development reference and is not intended as a standalone design guide.

---

**Navigation to Color Topics:**
- [**Primitive Colors**](01-primitive.md) - Foundation color values and token architecture
- [**Primitive Color Consumption**](02-primitive-consumption.md) - Which primitive colors are available for decorative usage
- [**Semantic Colors**](03-semantic.md) - Layer system, token resolution, and consumption patterns
  - [**Brand Colors**](05-semantic-brand.md) - Federal identity and brand implementation
  - [**Neutral Colors**](04-semantic-neutral.md) - Backgrounds, text, borders, surfaces
...
- **Mode adaptation**: Automatic adaptation to light/dark preferences
- **Accessibility compliance**: Built-in WCAG 2.1 AA contrast requirements
- **Consistent relationships**: Meaningful color relationships maintained across modes
...
- **Brand**: Primary federal identity color (Federal Red)
- **Brand applications**: Consistent federal identity across components

[View Brand Colors Documentation →](05-semantic-brand.md)
...
- **Shadow levels**: Depth indicators

[View Neutral Colors Documentation →](04-semantic-neutral.md)
...
[View Interaction Colors Documentation →](06-semantic-interaction.md)
...
[View Status Colors Documentation →](07-semantic-status.md)
...
[View Free Colors Documentation →](08-semantic-free.md)
...
The color system operates through multiple semantic layers. For detailed architectural information, see [Semantic Color Architecture](03-semantic.md).

#### Key Layers Overview
- **Lightness Semantic Level (S1)**: Lightness mode adaptation (light/dark modes)
...
|---------------|------------------|-------------------------|
| **Branding elements** | brand | [Brand Colors](05-semantic-brand.md) |
| **Typography** | neutral | [Neutral Colors](04-semantic-neutral.md) |
| **Buttons** | interaction | [Interaction Colors](06-semantic-interaction.md) |
| **Form inputs** | interaction + status | [Interaction Colors](06-semantic-interaction.md) + [Status Colors](07-semantic-status.md) |
| **Status indicators** | status | [Status Colors](07-semantic-status.md) |
| **Categorical labels, data viz** | free | [Free Colors](08-semantic-free.md) |
...
Each layer adds semantic meaning while maintaining flexibility for mode adaptation and component-specific requirements.
...
- **Maintain lightness-mode neutrality** - Let the system handle light/dark adaptation
- **Test cross-mode behavior** - Verify components work correctly in all modes
...
- **Typography**: Use type hierarchy and weight variations
