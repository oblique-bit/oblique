...
The path segment is `shadow` (correct snake_case); only the `$type` value is the exception. See [`../01-introduction/02-naming.md`](../01-introduction/02-naming.md) and [`../02-token-tiers/00-overview.md`](../02-token-tiers/00-overview.md).
...
- [`../02-token-tiers/03-semantic.md`](../02-token-tiers/03-semantic.md) — Semantic layer architecture and the primitive-bypass exception
- [`colors/01-primitive.md`](colors/01-primitive.md) — the `cobalt_alpha` primitive scale
- [`03-border.md`](03-border.md) — the other semantic-only, dimension-derived category
- [`../01-introduction/02-naming.md`](../01-introduction/02-naming.md) — the Tokens Studio `$type` exceptions
- [`../02-token-tiers/00-overview.md`](../02-token-tiers/00-overview.md) — `boxShadow` and composite Figma export behaviour
