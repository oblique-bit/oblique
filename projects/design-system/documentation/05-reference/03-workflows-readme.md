...
- [**Figma Variables Limitations & Restrictions**](05-figma-variables-limitations.md) - Known limitations and restrictions of Figma variables and variable modes
- [**Token Description Guidelines**](04-token-description-guidelines.md) - How to write a token's `$description` field
...
3. **Include automation** - Use scripts and tools where possible
