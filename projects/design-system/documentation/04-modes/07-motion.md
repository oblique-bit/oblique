...
[Motion Tokens](../03-token-categories/02-motion.md). This page
...
[Token Types](../02-token-tiers/00-overview.md) for the type-by-type Figma support
table.
...
[Modes Interplay](08-interplay.md) for how the modes combine.
