...
**Guidelines:**
- **Never consume a primitive color directly** in a component or application — always go through the semantic layer, the same rule that applies to every other color family (see [Token Reference Pattern](../../01-tiers/04-component-tokens.md#token-reference-pattern)).
...
- [Colors Overview](00-colors-overview.md) - Decorative vs semantic usage guidelines
- [Semantic Colors](03-colors-semantic.md) - Technical implementation details
- [Free Colors](08-colors-semantic-free.md) - The `free` tier in full
