...
### Layer Structure
- **`ob.g.theme_configuration.viewport.mobile.*`** - Global tokens (system-wide foundation)
- **`ob.p.assets.logo.*`** - Primitive tokens (raw values)
- **`ob.s1.color.neutral.bg.contrast_highest.inversity_normal.*`** - Semantic layer 1 (lightness variations)
- **`ob.s2.*`** - Semantic layer 2 (emphasis variations) 
- **`ob.s3.color.brand.*`** - Component tokens (inherit from semantic)
- **`ob.h.list.single_item.spacing.marker_gap.*`** - HTML element tokens (inherit from semantic/component)

**For Component Design**: Always use **`ob.s3.color.brand.*` tokens for all color decisions in components
2. **Reference Component Tokens**: Use `ob.c.tag.container.spacing.gap when working with specific components
3. **Use Other Semantic Tokens**: Use `ob.s.z_index.stepper_mobile.*` for spacing, typography, sizing (non-color tokens)
4. **Avoid Lower Layers**: Don't use `ob.s1.color.neutral.bg.contrast_highest.inversity_normal.*` or `ob.s2.*` directly in component designs
5. **Avoid Primitives**: Don't use `ob.p.assets.logo.*` tokens directly in designs
...
```
ob.s.spacing.heading.top.none      (0)
ob.s.spacing.heading.top        (0.5 units)
ob.s.spacing.heading.top        (1 unit)
ob.s.spacing.heading.top        (1.5 units)
ob.s.spacing.heading.top        (2 units)
ob.s.spacing.heading.top        (2.5 units)
ob.s.spacing.heading.top.2xl       (3 units)
ob.s.spacing.heading.top.3xl       (4 units)
ob.s.spacing.heading.top.4xl       (5 units)
ob.s.spacing.heading.top.5xl       (6 units)
ob.s.spacing.heading.top.6xl       (7 units)
```
...
ob.h.link.color.link.text-label.font-size.md
```

### **Component Tokens**
```
ob.c.tag.container.spacing.gap.info.enabled
ob.c.tag.container.spacing.gap.info.enabled
ob.c.tag.container.spacing.gap.padding-top
ob.c.tag.container.spacing.gap.padding-right
ob.c.tag.container.spacing.gap.padding-left
ob.c.tag.container.spacing.gap.padding.horizontal.md
```

### **Sizing Tokens**
```
ob.s.z_index.stepper_mobile.size.none
ob.s.z_index.stepper_mobile.size.nano
ob.s.z_index.stepper_mobile.size.micro
ob.s.z_index.stepper_mobile.size.tiny
ob.s.z_index.stepper_mobile.size.compact
ob.s.z_index.stepper_mobile.size.normal
ob.s.z_index.stepper_mobile.size.spacious
ob.s.z_index.stepper_mobile.size.hefty
ob.s.z_index.stepper_mobile.size.ultra
```

### **Border & Radius Tokens**
```
ob.s.z_index.stepper_mobile.radii.none
ob.s.z_index.stepper_mobile.radii.sm
ob.s.z_index.stepper_mobile.radii.md
ob.s.z_index.stepper_mobile.radii.lg
ob.s.z_index.stepper_mobile.radii.round
ob.s.z_index.stepper_mobile.border-width.xs
ob.s.z_index.stepper_mobile.border-width.sm
ob.s.z_index.stepper_mobile.border-width.md
```

### **Typography Tokens**
```
ob.s.z_index.stepper_mobile.fontSize.xs
ob.s.z_index.stepper_mobile.fontSize.sm
ob.s.z_index.stepper_mobile.fontSize.md
ob.s.z_index.stepper_mobile.fontSize.lg
ob.s.z_index.stepper_mobile.fontSize.xl
ob.s.typography.content.heading.default.H1.type-scale.md.normal
ob.s.typography.content.heading.default.H1.type-scale.lg.strong
```
...
- **Apply proper color tokens** based on component type:
  - Status components: `ob.s3.color.brand.*`
  - Neutral components: `ob.s3.color.brand`
...
#### Global Tokens (`ob.g.theme_configuration.viewport.mobile.*`)
...
#### Primitive Tokens (`ob.p.assets.logo.*`)
...
#### Semantic Tokens (`ob.s.z_index.stepper_mobile.*`)
