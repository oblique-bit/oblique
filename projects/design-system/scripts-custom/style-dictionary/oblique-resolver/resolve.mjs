 ...
 * checkout of `master`), with one overlay file applied first:
 *
 *   themes.mjs  mode discovery, rewritten for the tokens-dev token structure
 *
...
cpSync(join(here, 'themes.mjs'), join(wtDs, 'scripts', 'tokens', 'themes.mjs'));
