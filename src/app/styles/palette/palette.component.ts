	...
	colorGroups: Colors[] = [
		...
		},
		{
			...
			colors: [
				...
				{name: '$warning-400', color: '#f07703', contrast: '#171717'},
				{name: '$warning-500', color: '#e75e00', contrast: '#171717'},
		...
		},
		{
			...
			colors: [
				...
				{name: '$brand-warning', color: '#e75e00', contrast: '#171717', details: '$warning-500'},
